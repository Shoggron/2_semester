...
public class StatistikPane extends GridPane {
	...
	private void initContent() {
		...
		// Adding listeners
		txfVægtFra.setOnKeyReleased(event -> this.updateDetails());
		txfVægtTil.setOnKeyReleased(event -> this.updateDetails());
		lstLægemidler.setOnAction(event -> this.updateDetails());
	...
	public void updateDetails() {
		try {
			...
			int antal = Controller.antalOrdinationerPrVægtPrLægemiddel(vFra, vTil, lægemiddel);
